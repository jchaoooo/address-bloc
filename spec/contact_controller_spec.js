...
describe("ContactController", () => {
  ...
  describe("#addContact()", () => {
    it("should add a single contact into the book", (done) => {
      ...
      this.book.addContact("Alice", "001-101-1010", "Alice@blocStudent.io")
      .then((contact) => {
  ...
  describe("#getContacts()", () => {
    it("should return an empty array when no contacts available", (done) => {
  ...
  describe("search methods", () => {
    ...
    describe("#iterativeSearch()", () => {
      ...
      it("should return null when contact is not found", (done) => {
        ...
        .then(() => {
          this.book.getContacts()
          .then ((contacts) => {
            expect(this.book.iterativeSearch(contacts, "Alloy Rodriquez")).toBeNull();
            done();
          })
          .catch((err) => {
            console.log(err);
    ...
    describe("#search()", () => {
      it("should return ull when a contact was not found", (done) => {
        this.book.addContact(...zelda)
        .then(() => {
